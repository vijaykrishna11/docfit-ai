...
describe('SearchForm', () => {
  ...
  it('renders the specialty/insurance dropdowns, location input, radius selector, and CTA', () => {
    render(<SearchForm specialties={SPECIALTIES} insuranceCarriers={[{ id: 1, name: 'Aetna' }]} onSearch={vi.fn()} />)
  ...
  it('submits the typed location and selected radius', () => {
    ...
    render(<SearchForm specialties={SPECIALTIES} insuranceCarriers={[]} onSearch={onSearch} />)
  ...
  it('shows a helpful message when geolocation permission is denied', async () => {
    ...
    render(<SearchForm specialties={SPECIALTIES} insuranceCarriers={[]} onSearch={vi.fn()} />)
